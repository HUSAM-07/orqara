...
This example adds **Catppuccin Mocha** to Settings → Appearance. Orqara ships Catppuccin as a
...
`base`, `text`, `surface0`, `surface1`, `mauve`, `subtext0`, and `overlay0`. Orqara expands them
