...
describe("ReplicaCache", () => {
  ...
  it("round-trips explicit directory and timeline commits", async () => {
    ...
    expect(restoredDirectory.projects.get("project-1")?.projectDisplayName).toBe("Orqara");
  ...
  it("treats a corrupt row as a scoped miss", async () => {
    ...
    expect(restored.projects.get("project-1")?.projectDisplayName).toBe("Orqara");
