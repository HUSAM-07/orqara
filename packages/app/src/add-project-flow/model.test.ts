...
describe("Add Project options", () => {
  ...
  it("offers manual URL and protocol-specific owner/repo clone choices", () => {
    expect(buildManualGithubRepositoryChoices("git@github.com:HUSAM-07/orqara.git")).toEqual([
      expect.objectContaining({
        id: "manual:git@github.com:HUSAM-07/orqara.git",
        nameWithOwner: "HUSAM-07/orqara",
        cloneUrl: "git@github.com:HUSAM-07/orqara.git",
      }),
    ]);
    expect(buildManualGithubRepositoryChoices("HUSAM-07/orqara")).toEqual([
      expect.objectContaining({ cloneProtocol: "https", cloneUrl: "HUSAM-07/orqara" }),
      expect.objectContaining({ cloneProtocol: "ssh", cloneUrl: "HUSAM-07/orqara" }),
    ]);
