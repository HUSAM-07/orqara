...
describe("createSidebarWorkspaceEntry workspace directory label", () => {
  it("uses the daemon-provided slug for a Orqara-owned worktree", () => {
...
describe("shared sidebar workspace model", () => {
  it("feeds project placement and status grouping from the same cross-host workspace identities", () => {
    const model = buildSidebarWorkspacePlacementModel({
      projects: [
        project({
          projectKey: "HUSAM-07/orqara",
          projectName: "HUSAM-07/orqara",
          iconWorkingDir: "/repo/HUSAM-07/orqara",
          hosts: [
            {
              serverId: "host-a",
              iconWorkingDir: "/repo/HUSAM-07/orqara",
          ...
          workspaces: new Map([
            [
              ...
              workspace({
                id: "main",
                name: "main",
                projectId: "HUSAM-07/orqara",
                projectDisplayName: "HUSAM-07/orqara",
                status: "done",
              }),
            ],
          ]),
    ...
    expect(model.projectNamesByViewKey).toEqual(new Map([["HUSAM-07/orqara", "HUSAM-07/orqara"]]));
  });
