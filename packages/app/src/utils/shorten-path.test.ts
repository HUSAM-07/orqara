...
describe("shortenPath", () => {
  it("shortens a macOS home directory path", () => {
    expect(shortenPath("/Users/developer/dev/paseo")).toBe("~/dev/paseo");
  });

  it("shortens a Linux home directory path", () => {
    expect(shortenPath("/home/developer/dev/paseo")).toBe("~/dev/paseo");
  });
  ...
  it("leaves Windows paths unchanged", () => {
    expect(shortenPath("C:\\Users\\developer\\dev\\paseo")).toBe(
      "C:\\Users\\developer\\dev\\paseo",
    );
  });
