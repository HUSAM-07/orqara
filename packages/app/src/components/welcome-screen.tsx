...
export function WelcomeScreen({ onHostAdded }: WelcomeScreenProps) {
  ...
  const handleOpenOrqaraSite = useCallback(() => {
    void openExternalUrl("https://orqara.pages.dev");
  }, []);
      ...
      >
        <View style={styles.content}>
          ...
          <View style={styles.copyBlock}>
            ...
            {isNative ? (
              <Pressable style={styles.setupLink} onPress={handleOpenOrqaraSite}>
                <Text style={styles.setupLinkText}>orqara.pages.dev</Text>
