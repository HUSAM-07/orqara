...
import { WorkspaceTasksButton } from "@/screens/workspace/workspace-tasks-button";
  ...
  const headerRight = useMemo(
    () => (
      <View style={styles.headerRight}>
        {!isMobile ? (
          <WorkspaceTasksButton serverId={normalizedServerId} workspaceId={normalizedWorkspaceId} />
        ) : null}
