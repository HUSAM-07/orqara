...
function getPrimaryActionId(input: BuildGitActionsInput): GitActionId | null {
  ...
  // Only Orqara-owned worktrees get Archive as a fallback primary action.
...
function hasPushableCommits(input: BuildGitActionsInput): boolean {
  ...
  // No-upstream Orqara worktrees are first-pushable: the daemon push sets upstream with `git push -u`.
