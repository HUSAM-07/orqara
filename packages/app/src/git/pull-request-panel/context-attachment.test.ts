...
const baseInput = {
  ...
  pullRequest: {
    ...
    url: "https://github.com/HUSAM-07/orqara/pull/42",
  },
...
function comment(overrides: Partial<PrPaneActivity> = {}): PrPaneActivity {
  return {
    ...
    body: "Looks good.",
    age: "3d ago",
    url: "https://github.com/HUSAM-07/orqara/pull/42#issuecomment-1",
    ...overrides,
  };
}
...
function review(overrides: Partial<PrPaneActivity> = {}): PrPaneActivity {
  return {
    ...
    age: "2d ago",
    url: "https://github.com/HUSAM-07/orqara/pull/42#pullrequestreview-1",
    ...overrides,
  };
}
...
function check(overrides: Partial<PrPaneCheck> = {}): PrPaneCheck {
  return {
    ...
    provider: "github",
    status: "failure",
    url: "https://github.com/HUSAM-07/orqara/actions/runs/456/job/789",
  ...
  it("formats a comment as a workspace context attachment", () => {
    expect(
      ...
      text: [
        ...
        "Pull request URL: https://github.com/HUSAM-07/orqara/pull/42",
        "URL: https://github.com/HUSAM-07/orqara/pull/42#issuecomment-1",
        "Author: octocat",
        "Created: 3d ago",
    ...
    expect(
      buildPullRequestCheckContextAttachment({
        ...
        githubDetails: {
          ...
          conclusion: "failure",
          url: "https://github.com/HUSAM-07/orqara/actions/runs/456/job/789",
          detailsUrl: "https://github.com/HUSAM-07/orqara/actions/runs/456/job/789",
      ...
      text: [
        ...
        "Status: failure",
        "Conclusion: failure",
        "Check URL: https://github.com/HUSAM-07/orqara/actions/runs/456/job/789",
        "Details URL: https://github.com/HUSAM-07/orqara/actions/runs/456/job/789",
        ...
        "Failed jobs:",
        "- test: failure",
        "  https://github.com/HUSAM-07/orqara/actions/runs/456/job/789",
        "  ```",
        "  last line",
        "  ```",
        "",
  ...
  it("formats metadata-only failed check context when details are unavailable", () => {
    expect(
      buildPullRequestCheckContextAttachment({
        ...
        check: check({
          name: "status/context",
          url: "https://github.com/HUSAM-07/orqara/status/context",
          detailRef: undefined,
        }),
        githubDetails: null,
      }),
      ...
      text: [
        ...
        "Status: failure",
        "Check URL: https://github.com/HUSAM-07/orqara/status/context",
      ].join("\n"),
    });
  });
    ...
    return {
      ...
      comments: [
        comment({
          ...
          url: "https://github.com/HUSAM-07/orqara/pull/42#discussion_r1",
        }),
