...
describe("tool call detail-level projection", () => {
  ...
  it("counts Orqara calls separately from other tools", () => {
    const calls = [
      ...
      toolCall("3", { type: "fetch", url: "https://orqara.pages.dev" }),
      toolCall("4", { type: "fetch", url: "https://github.com/HUSAM-07" }),
    ];
  ...
  it("classifies direct Brave search and Orqara runtime tool names", () => {
