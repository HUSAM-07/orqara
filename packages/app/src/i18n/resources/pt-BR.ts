...
export const ptBR: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Arquivar não está disponível aqui porque este workspace não foi criado como um worktree do Orqara",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Permitir que o Orqara inicie e pare o daemon integrado",
        ...
        registrationFailed:
          "O daemon integrado foi iniciado, mas o Orqara não conseguiu salvar a conexão localhost. Desative e reative o gerenciamento do daemon ou adicione localhost manualmente.",
        pausedStopFailed:
          "O gerenciamento do daemon integrado foi pausado, mas o Orqara não conseguiu parar o daemon.",
        updateFailed: "Não foi possível atualizar o gerenciamento do daemon integrado.",
      },
      keepRunning: {
        title: "Manter daemon em execução ao sair",
        hint: "O daemon continua em execução quando você sai do Orqara",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel: "Você está executando a build Intel do Orqara pelo Rosetta no Apple Silicon.",
    ...
    permissions: {
      ...
      testNotification: {
        title: "Teste de notificação do Orqara",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Não foi possível instalar a CLI do Orqara.",
      },
    },
  },
  rootError: {
    title: "O Orqara encontrou um problema.",
  ...
  pairing: {
    ...
    direct: {
      title: "Conexão direta",
      helper: "Informe o endereço de um servidor Orqara.",
      fields: {
        host: "Host",
        port: "Porta",
        password: "Senha",
    ...
    remoteSsh: {
      title: "SSH remoto",
      helper: "Conecte-se a um daemon Orqara no host remoto.",
      fields: {
        target: "Host SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Leia como o relay do Orqara funciona",
      ...
      updateRequired: "Atualize o host para ativar o relay pelo Orqara Desktop.",
      unavailable: "Oferta de pareamento indisponível.",
      hint: "Escaneie este QR code com o Orqara no seu celular ou copie o link abaixo.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "chamou o Orqara {{count}} vez",
      other: "chamou o Orqara {{count}} vezes",
    },
    and: "e",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "O Orqara entregou a notificação ao sistema operacional.",
    ...
    metadataGeneration: {
      ...
      description:
        "Escolha o modelo usado pelo Orqara para títulos de espaços de trabalho, nomes de branches, mensagens de commit e rascunhos de pull request",
      selection: "Seleção de modelo",
      automatic: "Automática",
      preferred: "Manual",
      automaticHint: "O Orqara escolhe um modelo rápido disponível",
      preferredHint: "Escolha o modelo que o Orqara usa",
      model: "Modelo",
      fallbackHint: "Se ele não estiver disponível, o Orqara usa outro modelo disponível",
      docs: "Documentação",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "As abas do navegador compartilham logins e dados de sites no Orqara.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Isso atualiza o Orqara neste computador",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Atualizar Orqara skills?",
        updateFallback: "Sincronize as skills incluídas com sua máquina.",
        uninstallTitle: "Desinstalar Orqara skills?",
        uninstallMessage:
          "Remove todas as skills de orquestração do Orqara de ~/.agents, ~/.claude e ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Ativar ferramentas do Orqara",
          hint: "Agentes poderão gerenciar worktrees, agentes e agendamentos",
          accessibilityLabel: "Injetar ferramentas do Orqara",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este host está offline. O Orqara reconecta automaticamente. Aguarde ele voltar a ficar online antes de reiniciar.",
          requestFailedTitle: "Erro",
          requestFailedMessage:
            "Falha ao enviar a solicitação de reinício. O Orqara reconecta automaticamente. Tente novamente quando o host aparecer como online.",
          dialogFailedMessage: "Não foi possível abrir o diálogo de confirmação de reinício.",
        },
        update: {
          desktopManagedHint:
            "Este daemon é gerenciado pelo Orqara Desktop. Atualize o Orqara Desktop no host.",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "O Orqara supervisiona o processo e atribui uma porta via $PASEO_PORT",
        actions: {
      ...
      metadata: {
        title: "Geração de metadados",
        info: "Instruções específicas do projeto injetadas nos prompts de IA que o Orqara usa para gerar metadados. Use-as para aplicar convenções da sua equipe, como nomes de branch, estilo de commit ou formato de PR",
