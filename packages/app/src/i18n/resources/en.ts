export const en = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Archive isn't available here because this workspace was not created as a Orqara worktree",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Let Orqara start and stop the built-in daemon",
        ...
        pausedStopFailed:
          "Built-in daemon management was paused, but Orqara could not stop the daemon.",
        updateFailed: "Unable to update built-in daemon management.",
      },
      keepRunning: {
        title: "Keep daemon running after quit",
        hint: "Daemon keeps running when you quit Orqara",
      },
      logs: {
        title: "Log file",
    ...
    rosetta: {
      ...
      runningIntel: "You're running the Intel build of Orqara under Rosetta on Apple Silicon.",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Unable to install the Orqara CLI.",
      },
    },
  },
  rootError: {
    title: "Orqara ran into a problem.",
  ...
  pairing: {
    ...
    direct: {
      title: "Direct connection",
      helper: "Enter the address of a Orqara server.",
      fields: {
        host: "Host",
        port: "Port",
        password: "Password",
    ...
    remoteSsh: {
      title: "Remote SSH",
      helper: "Connect to a Orqara daemon running on the remote host.",
      fields: {
        target: "SSH host",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Read how Orqara relay works",
      ...
      updateRequired: "Update the host to enable relay from Orqara Desktop.",
      unavailable: "Pairing offer unavailable.",
      hint: "Scan this QR code with Orqara on your phone, or copy the link below.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "called Orqara {{count}} time",
      other: "called Orqara {{count}} times",
    },
    and: "and",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Orqara handed the notification to the operating system.",
    ...
    metadataGeneration: {
      ...
      description:
        "Choose the model Orqara uses for workspace titles, branch names, commit messages, and pull request drafts",
      selection: "Model selection",
      automatic: "Automatic",
      preferred: "Manual",
      automaticHint: "Orqara picks a fast available model",
      preferredHint: "Choose the model Orqara uses",
      model: "Model",
      fallbackHint: "If it is unavailable, Orqara falls back to another available model",
      docs: "Docs",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Browser tabs share sign-ins and site data across Orqara.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "This updates Orqara on this computer",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Update Orqara skills?",
        updateFallback: "Sync bundled skills to this host.",
        uninstallTitle: "Uninstall Orqara skills?",
        uninstallMessage:
          "Removes all Orqara orchestration skills from ~/.agents, ~/.claude, ~/.codex on this host.",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "This host is offline. Orqara reconnects automatically-wait until it's back online before restarting.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "Failed to send the restart request. Orqara reconnects automatically-try again once the host shows as online.",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Orqara supervises the process and assigns a port via $PASEO_PORT",
        actions: {
          add: "Add script",
          edit: "Edit",
          remove: "Remove",
      ...
      metadata: {
        title: "Metadata generation",
        info: "Project-specific instructions injected into the AI prompts Orqara uses to generate metadata - use them to enforce your team's conventions like branch naming, commit style, or PR format",
