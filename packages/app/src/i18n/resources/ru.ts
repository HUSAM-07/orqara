...
export const ru: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Архивирование недоступно: это рабочее пространство не было создано как worktree Orqara.",
  ...
  desktop: {
    ...
    quitting: {
      title: "Завершение работы Orqara...",
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Разрешить Orqara запускать и останавливать встроенный демон",
        ...
        registrationFailed:
          "Встроенный демон запущен, но Orqara не удалось сохранить подключение к localhost. Выключите и снова включите управление демоном или добавьте localhost вручную.",
        pausedStopFailed:
          "Встроенное управление демоном было приостановлено, но Orqara не смог остановить демон.",
        updateFailed: "Не удалось изменить настройки управления встроенным демоном.",
      },
      keepRunning: {
        title: "Продолжать работу демона после выхода",
        hint: "Демон продолжит работать после выхода из Orqara",
      },
      logs: {
        title: "Файл журнала",
    ...
    rosetta: {
      ...
      runningIntel: "Вы используете сборку Orqara для Intel через Rosetta на Apple Silicon.",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Не удалось установить Orqara CLI.",
      },
    },
  },
  rootError: {
    title: "В Orqara возникла проблема.",
  ...
  onboarding: {
    title: "Добро пожаловать в Orqara",
  ...
  pairing: {
    ...
    direct: {
      title: "Прямое подключение",
      helper: "Введите адрес сервера Orqara.",
      fields: {
        host: "Хост",
        port: "Порт",
        password: "Пароль",
    ...
    remoteSsh: {
      title: "Удалённый SSH",
      helper: "Подключитесь к демону Orqara на удалённом хосте.",
      fields: {
        target: "Хост SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Узнать, как работает ретранслятор Orqara",
      ...
      updateRequired: "Обновите хост, чтобы включить ретранслятор из Orqara Desktop.",
      unavailable: "Данные для сопряжения недоступны.",
      hint: "Отсканируйте этот QR-код с помощью Orqara на телефоне или скопируйте ссылку ниже.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "выполнен {{count}} вызов Orqara",
      other: "выполнены вызовы Orqara ({{count}})",
    },
    and: "и",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Orqara передал уведомление операционной системе.",
    ...
    metadataGeneration: {
      ...
      description:
        "Выберите модель, которую Orqara будет использовать для названий рабочих пространств и веток, сообщений коммитов и черновиков PR",
      selection: "Выбор модели",
      automatic: "Автоматически",
      preferred: "Вручную",
      automaticHint: "Orqara выбирает быструю доступную модель",
      preferredHint: "Выберите модель, которую использует Orqara",
      model: "Модель",
      fallbackHint: "Если она недоступна, Orqara использует другую доступную модель",
      docs: "Документация",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Вкладки браузера в Orqara используют общие данные входа и данные сайтов.",
    ...
    about: {
      ...
      releaseChannel: {
        label: "Канал выпуска",
        description:
          "Переключитесь на бета-канал, чтобы раньше получать обновления и помогать развивать Orqara.",
        stable: "Стабильный",
        beta: "Бета",
      },
      updates: {
        ...
        installMessage: "Это обновит Orqara на этом компьютере.",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Обновить навыки Orqara?",
        updateFallback: "Встроенные навыки будут синхронизированы с этим хостом.",
        uninstallTitle: "Удалить навыки Orqara?",
        uninstallMessage:
          "Удаляет все навыки оркестрации Orqara из ~/.agents, ~/.claude и ~/.codex на этом хосте.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Включить инструменты Orqara",
          hint: "Агенты смогут управлять worktree, агентами и расписаниями.",
          accessibilityLabel: "Добавить инструменты Orqara",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Этот хост не в сети. Orqara переподключится автоматически. Дождитесь подключения перед перезапуском.",
          requestFailedTitle: "Ошибка",
          requestFailedMessage:
            "Не удалось отправить запрос на перезапуск. Orqara переподключается автоматически. Повторите попытку, когда хост появится в сети.",
          dialogFailedMessage: "Не удалось открыть диалог подтверждения перезапуска.",
        },
        update: {
          desktopManagedHint:
            "Этот демон управляется Orqara Desktop. Обновите Orqara Desktop на хосте.",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Orqara управляет процессом и назначает порт через переменную $PASEO_PORT.",
        actions: {
          add: "Добавить скрипт",
          edit: "Редактировать",
          remove: "Удалить",
      ...
      metadata: {
        title: "Генерация метаданных",
        info: "Инструкции для этого проекта, добавляемые в промпты ИИ, с помощью которых Orqara генерирует метаданные. Используйте их, чтобы соблюдать принятые в команде правила именования веток, оформления коммитов и формата PR.",
