...
export const es: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "El archivo no está disponible aquí porque este espacio de trabajo no se creó como un árbol de trabajoOrqara",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Deje queOrqarainicie y detenga el demonio incorporado",
        ...
        pausedStopFailed:
          "La gestión del demonio integrado se pausó, peroOrqarano pudo detener el demonio.",
      ...
      keepRunning: {
        ...
        hint: "Daemonsigue ejecutándose cuando sales deOrqara",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel: "Estás ejecutando la compilaciónInteldeOrqaraenRosettaenApple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Prueba de notificaciónOrqara",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "No se puede instalar elOrqaraCLI.",
      },
    },
  },
  rootError: {
    title: "Orqara tuvo un problema.",
  ...
  pairing: {
    ...
    direct: {
      title: "Conexión directa",
      helper: "Ingrese la dirección de un servidorOrqara.",
      fields: {
        host: "Host",
        port: "Puerto",
        password: "Contraseña",
    ...
    remoteSsh: {
      title: "SSH remoto",
      helper: "Conéctate a un daemon de Orqara en el host remoto.",
      fields: {
        target: "Host SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Leer cómo funciona el relé de Orqara",
      ...
      updateRequired: "Actualice el host para habilitar el relé desde Orqara Desktop.",
      unavailable: "Oferta de maridaje no disponible.",
      hint: "Escanee este códigoQRconOrqaraen su teléfono o copie el enlace a continuación.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "llamó a Orqara {{count}} vez",
      other: "llamó a Orqara {{count}} veces",
    },
    and: "y",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Orqara entregó la notificación al sistema operativo.",
    ...
    metadataGeneration: {
      ...
      description:
        "Elige el modelo que Orqara usa para títulos de espacios de trabajo, nombres de ramas, mensajes de commit y borradores de pull requests",
      selection: "Selección de modelo",
      automatic: "Automática",
      preferred: "Manual",
      automaticHint: "Orqara elige un modelo rápido disponible",
      preferredHint: "Elige el modelo que usa Orqara",
      model: "Modelo",
      fallbackHint: "Si no está disponible, Orqara usa otro modelo disponible",
      docs: "Documentación",
    ...
    general: {
      ...
      browserData: {
        ...
        description:
          "Las pestañas del navegador comparten inicios de sesión y datos de sitios en Orqara.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Esto actualizaOrqaraen esta computadora.",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "¿Actualizar las habilidades deOrqara?",
        updateFallback: "Sincronice las habilidades incluidas con su máquina.",
        uninstallTitle: "¿Desinstalar las habilidadesOrqara?",
        uninstallMessage:
          "Elimina todas las habilidades de orquestaciónOrqarade ~/.agents, ~/.claude, ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Habilitar herramientasOrqara",
          hint: "Los agentes podrán gestionar árboles de trabajo, agentes y horarios.",
          accessibilityLabel: "Inyectar herramientasOrqara",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este anfitrión está desconectado.Orqarase vuelve a conectar automáticamente; espere hasta que vuelva a estar en línea antes de reiniciar.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "No se pudo enviar la solicitud de reinicio.Orqarase vuelve a conectar automáticamente; inténtelo nuevamente una vez que el host se muestre en línea.",
          dialogFailedMessage:
            "No se puede abrir el cuadro de diálogo de confirmación de reinicio.",
        },
        update: {
          desktopManagedHint:
            "Este daemon está administrado por Orqara Desktop. Actualiza Orqara Desktop en el host.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Orqarasupervisa el proceso y asigna un puerto vía $PASEO_PORT",
        actions: {
          add: "Agregar guión",
          edit: "Editar",
          remove: "Eliminar",
      ...
      metadata: {
        title: "Generación de metadatos",
        info: "Instrucciones específicas del proyecto inyectadas en los mensajes de IA queOrqarautiliza para generar metadatos; úselas para hacer cumplir las convenciones de su equipo, como la denominación de ramas, el estilo de confirmación o el formatoPR.",
