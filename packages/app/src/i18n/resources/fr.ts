...
export const fr: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "L'archive n'est pas disponible ici car cet espace de travail n'a pas été créé en tant qu'arbre de travailOrqara",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "LaissezOrqaradémarrer et arrêter le démon intégré",
        ...
        pausedStopFailed:
          "La gestion du démon intégré a été suspendue, maisOrqaran'a ​​pas pu arrêter le démon.",
      ...
      keepRunning: {
        ...
        hint: "Daemoncontinue de fonctionner lorsque vous quittezOrqara",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel: "Vous exécutez la versionInteldeOrqarasousRosettasurApple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Test de notificationOrqara",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Impossible d'installer leOrqaraCLI.",
      },
    },
  },
  rootError: {
    title: "Orqara a rencontré un problème.",
  ...
  pairing: {
    ...
    direct: {
      title: "Connexion directe",
      helper: "Saisissez l'adresse d'un serveurOrqara.",
      fields: {
        host: "Host",
        port: "Port",
    ...
    remoteSsh: {
      title: "SSH distant",
      helper: "Connectez-vous à un daemon Orqara sur l’hôte distant.",
      fields: {
        target: "Hôte SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Lire comment fonctionne le relais Orqara",
      ...
      updateRequired: "Mettez à jour l’hôte pour activer le relais depuis Orqara Desktop.",
      unavailable: "Offre de jumelage indisponible.",
      hint: "Scannez ce codeQRavecOrqarasur votre téléphone ou copiez le lien ci-dessous.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "a appelé Orqara {{count}} fois",
      other: "a appelé Orqara {{count}} fois",
    },
    and: "et",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Orqara a transmis la notification au système d’exploitation.",
    ...
    metadataGeneration: {
      ...
      description:
        "Choisissez le modèle utilisé par Orqara pour les titres d’espaces de travail, les noms de branches, les messages de commit et les brouillons de pull request",
      selection: "Sélection du modèle",
      automatic: "Automatique",
      preferred: "Manuel",
      automaticHint: "Orqara choisit un modèle rapide disponible",
      preferredHint: "Choisissez le modèle utilisé par Orqara",
      model: "Modèle",
      fallbackHint: "S’il est indisponible, Orqara utilise un autre modèle disponible",
      docs: "Documentation",
    ...
    general: {
      ...
      browserData: {
        ...
        description:
          "Les onglets du navigateur partagent les connexions et les données des sites dans Orqara.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Cela met à jourOrqarasur cet ordinateur",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Mettre à jour les compétencesOrqara?",
        updateFallback: "Synchronisez les compétences regroupées sur votre machine.",
        uninstallTitle: "Désinstaller les compétencesOrqara?",
        uninstallMessage:
          "Supprime toutes les compétences d'orchestrationOrqarade ~/.agents, ~/.claude, ~/.codex.",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Cet hôte est hors ligne.Orqarase reconnecte automatiquement: attendez qu'il soit de nouveau en ligne avant de redémarrer.",
          requestFailedTitle: "Erreur",
          requestFailedMessage:
            "Échec de l'envoi de la demande de redémarrage.Orqarase reconnecte automatiquement - réessayez une fois que l'hôte apparaît comme en ligne.",
          dialogFailedMessage:
            "Impossible d'ouvrir la boîte de dialogue de confirmation de redémarrage.",
        },
        update: {
          desktopManagedHint:
            "Ce daemon est géré par Orqara Desktop. Mettez à jour Orqara Desktop sur l’hôte.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Orqarasupervise le processus et attribue un port via $PASEO_PORT",
        actions: {
      ...
      metadata: {
        title: "Génération de métadonnées",
        info: "Instructions spécifiques au projet injectées dans les invites de l'IA queOrqarautilise pour générer des métadonnées: utilisez-les pour appliquer les conventions de votre équipe telles que la dénomination des branches, le style de validation ou le formatPR.",
