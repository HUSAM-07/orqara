...
const RELEASE_DOWNLOAD_BASE_URL = "https://github.com/HUSAM-07/orqara/releases/download";
...
export function buildMacAppleSiliconDownloadUrl(version: string | null | undefined): string | null {
  ...
  return `${RELEASE_DOWNLOAD_BASE_URL}/v${normalizedVersion}/Orqara-${normalizedVersion}-arm64.dmg`;
}
