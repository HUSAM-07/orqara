export const meta = {
  ...
  description: "Inspect Orqara and explain what the project does",
  whenToUse: "Orqara real-provider workflow detail QA",
...
const report = await agent(
  `Inspect the Orqara repository at ${JSON.stringify(repoPath)}.
