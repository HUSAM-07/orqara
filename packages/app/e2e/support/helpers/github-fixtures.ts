...
async function seedPr(args: {
  ...
  git(["config", "user.name", "Orqara E2E"], localPath);
...
// Single namespace for temporary GitHub repos created by Orqara tests.
...
export async function createTempGithubRepo(options: {
  ...
  git(["config", "user.name", "Orqara E2E"], basePath);
...
export async function cloneGithubRepoDefaultBranchOnly(
  ...
  git(["config", "user.name", "Orqara E2E"], clonePath);
...
export async function createLocalGithubPrFixture(): Promise<LocalGhPrFixture> {
  ...
  git(["config", "user.name", "Orqara E2E"], checkoutPath);
