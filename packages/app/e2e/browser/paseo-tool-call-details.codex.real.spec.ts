...
function verificationPrompt(workspacePath: string): string {
  return [
    "Use Orqara tools to perform this exact UI verification.",
    ...
    "Use each named Orqara tool exactly once except for the matching schedule and heartbeat deletion tools.",
  ].join(" ");
}
...
test.describe("real Codex Orqara tool-call presentation", () => {
