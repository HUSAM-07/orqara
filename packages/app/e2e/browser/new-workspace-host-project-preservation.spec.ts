...
const SHARED_PROJECT_NAME = "Orqara";
const SHARED_REMOTE_URL = "https://github.com/HUSAM-07/orqara.git";
  ...
  crossHostProject: async ({ page: _page }, provide) => {
    ...
    try {
      ...
      const primarySharedProject = await createProject(primaryClient, {
        ...
        workspaceName: "Primary Orqara workspace",
      });
      ...
      const primaryDuplicateProject = await createProject(primaryClient, {
        ...
        projectName: "Orqara duplicate",
        workspaceName: "Duplicate Orqara workspace",
      });
      ...
      const secondarySharedProject = await createProject(secondaryClient, {
        ...
        projectName: SHARED_PROJECT_NAME,
        workspaceName: "Secondary Orqara workspace",
      });
      ...
      if (
        ...
        throw new Error("Expected the Orqara clones to have the same equivalence key");
      }
