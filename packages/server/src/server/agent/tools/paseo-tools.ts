...
export function createPaseoToolCatalog(options: PaseoToolHostDependencies): PaseoToolCatalog {
  ...
  const toCatalog = (): PaseoToolCatalog => ({
    ...
    async executeTool(
      ...
      if (!tool) {
        throw new Error(`Orqara tool not found: ${name}`);
      }
    ...
    z
      .object({
        ...
        worktreeSlug: z
          ...
          .min(1)
          .optional()
          .describe("Optional worktree slug/path label. Omit to let Orqara generate one."),
        branchName: z
          .string()
          .min(1)
          .optional()
      ...
      .strict()
      .describe("Create a new branch in a new Orqara worktree."),
    z
      .object({
      ...
      .strict()
      .describe("Check out an existing branch in a new Orqara worktree."),
    z
      .object({
      ...
      .strict()
      .describe("Check out a GitHub pull request in a new Orqara worktree."),
  ]);
  ...
  registerTool(
    "create_workspace",
    {
      ...
      description:
        "Create a workspace using an existing local checkout or a new Orqara-managed worktree.",
      inputSchema: {
        isolation: z.enum(["local", "worktree"]),
        path: z
          .string()
  ...
  registerTool(
    "start_workspace_script",
    {
      ...
      description:
        "Start one configured workspace script through Orqara's managed workspace-script launcher.",
      inputSchema: {
