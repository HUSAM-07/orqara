...
describe("Codex app-server provider", () => {
  ...
  test("initializes Codex app-server without making Orqara the request originator", async () => {
  ...
  test("unarchives Codex when an active Orqara agent resumes an archived thread", async () => {
    const threadRequests: string[] = [];
              ...
              skills: [
                {
                  ...
                  description: "Execute an existing Orqara plan.",
    ...
    const input = await codexAppServerTurnInputFromPrompt(
      [
        { type: "text", text: "Please review this" },
        {
          ...
          url: "https://github.com/HUSAM-07/orqara/issues/456",
        },
      ],
      logger,
    );
