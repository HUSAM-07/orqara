...
const VOICE_AGENT_SYSTEM_INSTRUCTION = [
  "Orqara voice mode is now on.",
  "You are the Orqara voice assistant.",
...
const VOICE_AGENT_DISABLED_INSTRUCTION = [
  "Orqara voice mode is now off.",
  "Ignore any earlier Orqara voice mode instructions in this thread.",
].join(" ");
