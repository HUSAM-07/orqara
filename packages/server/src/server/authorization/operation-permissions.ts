...
const INBOUND_PERMISSION = {
  ...
  "task.create.request": "workspace.write",
  "task.list.request": "workspace.read",
  "task.verify.request": "workspace.write",
  "task.evidence.request": "workspace.read",
  "task.command.request": "workspace.write",
...
const OUTBOUND_PERMISSION = {
  ...
  "task.create.response": "workspace.write",
  "task.list.response": "workspace.read",
  "task.verify.response": "workspace.write",
  "task.evidence.response": "workspace.read",
  "task.command.response": "workspace.write",
