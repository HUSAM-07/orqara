...
export function downloadUrls(release: ReleaseAssetInfo) {
  ...
  return {
    macAppleSilicon: `${base}/Orqara-${version}-arm64.dmg`,
    macIntel: `${base}/Orqara-${version}-x64.dmg`,
    linuxAppImage: `${base}/${linuxAppImageAsset}`,
    linuxDeb: `${base}/Orqara-${version}-amd64.deb`,
    linuxRpm: `${base}/Orqara-${version}-x86_64.rpm`,
    windowsExeX64: `${base}/${windowsX64Asset ?? `Orqara-Setup-${version}-x64.exe`}`,
    windowsExeArm64: windowsArm64Asset ? `${base}/${windowsArm64Asset}` : null,
    androidApk: `${base}/orqara-v${version}-android.apk`,
  };
}
