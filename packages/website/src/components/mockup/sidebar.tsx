...
const ORQARA: Avatar = { kind: "orqara" };
...
const DONE_ROWS: WorkspaceRow[] = [
  { id: "beta", title: "Release v0.7.0-beta.2", avatar: ORQARA, time: "2h" },
  {
    id: "blank-page-focus",
  ...
  { id: "resume", title: "Resume in-progress work", avatar: ORQARA, time: "3d" },
  { id: "undef", title: "Undefined task", avatar: ORQARA, time: "3d" },
  { id: "codex-issue", title: "Diagnose cloud/Codex issue re…", avatar: ORQARA, time: "4d" },
  { id: "cws", title: "Diagnose create_workspace 37…", avatar: ORQARA, time: "4d" },
  { id: "taps", title: "Diagnose tap interactions", avatar: ORQARA, time: "4d" },
  { id: "clarify", title: "Clarify task requirements", avatar: ORQARA, time: "5d" },
  { id: "abc", title: "Task for abcdefghi", avatar: ORQARA, time: "5d" },
];
