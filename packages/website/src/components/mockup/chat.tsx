...
export function AgentTranscript() {
  return (
    <div className="space-y-[13px] pt-[2px]">
      <Para>
        The launch page is built. It leads with Orqara&rsquo;s actual value, then uses the product
      ...
      <div>
        ...
        <Bullet>Built desktop and mobile scenes from real Orqara workflows and assets.</Bullet>
      ...
      <Para>PR opened: Build the launch page around verifiable agent work.</Para>
      <span className="block text-[13.5px] text-mock-accent-bright">
        https://github.com/HUSAM-07/orqara/pull/42
      </span>
      <div>
...
const PLUGIN_TOOL_CALLS: PluginToolCall[] = [
  { kind: "read", label: "Read", detail: "orqara-plugin/SKILL.md" },
  {
    kind: "shell",
    label: "Shell",
    detail: "orqara plugin init ~/dev/release-radar",
  },
  {
    kind: "write",
    label: "Write",
  ...
  },
  {
    kind: "shell",
    label: "Shell",
    detail: "orqara plugin install ~/dev/release-radar",
  },
];
...
export function PluginBuildTranscript() {
  return (
    <div className="space-y-[13px] pt-[2px]">
      <UserBubble>
        Build me a release radar for Orqara. I want an explorer panel showing merged PRs, changes in
      ...
      <Para>
        The plugin API exposes Orqara&rsquo;s live project and workspace state, so the radar
