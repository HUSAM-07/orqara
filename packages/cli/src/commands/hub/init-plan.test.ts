...
describe("Hub init scaffold", () => {
  ...
  it.each([
    ["github", { repo: "HUSAM-07/orqara", user: "boudra" }],
...
describe("GitHub origin detection", () => {
  it.each([
    ["git@github.com:HUSAM-07/orqara.git", "HUSAM-07/orqara"],
    ["ssh://git@github.com/HUSAM-07/orqara.git", "HUSAM-07/orqara"],
    ["https://github.com/HUSAM-07/orqara.git", "HUSAM-07/orqara"],
    ["https://gitlab.com/HUSAM-07/orqara.git", undefined],
