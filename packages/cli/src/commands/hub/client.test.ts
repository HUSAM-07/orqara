...
describe("Hub HTTP client", () => {
    ...
    const origin = await startServer(
      () => ({
        ...
        body: {
          ...
          discord: [{ slug: "paseo", guildName: "Orqara" }],
          slack: [{ slug: "paseo", teamName: "Orqara" }],
        },
      }),
      requests,
    );
    ...
    const origin = await startServer(
      () => ({
        ...
        body: {
          ...
          discord: [{ guildId: "guild-123", guildName: "Orqara" }],
          slack: [{ teamId: "team-123", teamName: "Orqara" }],
        },
      }),
      requests,
    );
  ...
  it.each([
    { github: [], discord: [], slack: [{ teamId: "team-123", teamName: "Orqara", slug: "wrong" }] },
    { github: [], discord: [], slack: [{ teamId: 123, teamName: "Orqara" }] },
