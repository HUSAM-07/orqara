  ...
  return (
    <View style={styles.screen}>
      ...
      <Pressable
        ...
        style={styles.button}
        onPress={() => greeting.mutate({ name: "Orqara" })}
      >
        <Text style={styles.buttonText}>Create greeting</Text>
      </Pressable>
      <Pressable
        accessibilityRole="link"
        accessibilityLabel="Open the Orqara website"
        style={styles.button}
        onPress={() => openExternal("https://orqara.pages.dev")}
      >
        <Text style={styles.buttonText}>Open Orqara</Text>
      </Pressable>
    </View>
  );
}
