...
export class DaemonClient {
  ...
  async createTask(
    input: Omit<TaskCreateRequest, "type" | "requestId">,
    requestId?: string,
  ): Promise<Extract<SessionOutboundMessage, { type: "task.create.response" }>["payload"]> {
    return this.sendCorrelatedSessionRequest({
      requestId,
      message: { type: "task.create.request", ...input },
      responseType: "task.create.response",
    });
  }
  ...
  async listTasks(
    workspaceId: string,
    requestId?: string,
  ): Promise<Extract<SessionOutboundMessage, { type: "task.list.response" }>["payload"]> {
    return this.sendCorrelatedSessionRequest({
      requestId,
  ...
  async verifyTask(
    ...
    requestId?: string,
  ): Promise<Extract<SessionOutboundMessage, { type: "task.verify.response" }>["payload"]> {
    return this.sendCorrelatedSessionRequest({
      requestId,
      message: { type: "task.verify.request", ...input },
      responseType: "task.verify.response",
    });
  }
  ...
  async getTaskEvidence(
    ...
    requestId?: string,
  ): Promise<Extract<SessionOutboundMessage, { type: "task.evidence.response" }>["payload"]> {
    return this.sendCorrelatedSessionRequest({
      requestId,
      message: { type: "task.evidence.request", ...input },
      responseType: "task.evidence.response",
    });
  }

  async commandTask(
    input: Omit<TaskCommandRequest, "type" | "requestId">,
    requestId?: string,
  ): Promise<Extract<SessionOutboundMessage, { type: "task.command.response" }>["payload"]> {
    return this.sendCorrelatedSessionRequest({
      requestId,
      message: { type: "task.command.request", ...input },
