...
TypeScript SDK for building integrations on top of a Orqara daemon.
...
The public API is the package root. Imports under `@getpaseo/client/internal/*` are unsupported implementation details used by Orqara's own packages.

Read the [SDK documentation](https://orqara.pages.dev/docs/sdk) for agents, workspaces, terminals, provider discovery, events, recipes, and the API reference. Runnable TypeScript patterns also live in [`examples/`](./examples/README.md).
