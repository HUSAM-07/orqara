...
describe("runtime-paths", () => {
  beforeEach(() => {
    ...
    setProcessRuntime({
      platform: "darwin",
      execPath: "/Applications/Orqara.app/Contents/MacOS/Orqara",
      resourcesPath: "/Applications/Orqara.app/Contents/Resources",
    });
  });
  ...
  it("uses the macOS Helper executable for packaged daemon node launches", () => {
    expect(resolveNodeExecPath()).toBe(
      "/Applications/Orqara.app/Contents/Frameworks/Orqara Helper.app/Contents/MacOS/Orqara Helper",
    );
  });
});
